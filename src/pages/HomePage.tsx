...
export default function HomePage() {
  ...
  return (
    <div className="relative flex h-[100dvh] w-full flex-col items-center overflow-hidden p-4 select-none">
      <style>{`
        /* Basic Fade in/float animations - Keep these for the logo/ui even in boring mode */
        @keyframes float {
      ...
      {/* FALLBACK BLOBS:
        ...
        They only appear when the "boring-mode" class is on the body (via the arbitrary modifier).
        Since animations are disabled in boring mode, these will be static blurred orbs.
      */}
      ...
      <main className="relative z-10 flex flex-1 w-full max-w-md flex-col items-center justify-center text-center animate-in fade-in zoom-in-95 duration-1000 pt-6 pb-2">
        <h1 className="font-lavish text-[clamp(4rem,15vw,9rem)] leading-[0.9] tracking-wide text-transparent bg-clip-text bg-gradient-to-br from-foreground to-foreground/50 dark:from-white dark:to-white/50 drop-shadow-lg select-none pb-1">
          QuickSync
        </h1>
        ...
        <div className="mt-2 sm:mt-4 w-full glass-panel rounded-3xl p-5 sm:p-8 transition-all duration-500 hover:shadow-2xl hover:border-white/30 group">
          <button
      ...
      <footer className="w-full max-w-6xl mx-auto flex shrink-0 items-center justify-between text-xs text-muted-foreground/60 pb-10 z-20 pointer-events-none">
